...
if(isset($_POST['submitgizi'])){
  ...
  if($simpan){
    header("location:kuesioner-kebersihan");
  }
}
?>
<div class="col-lg-12">
  <div align="center" class="row">
    <h3><b>PELAYANAN</b></h3>
    <h1><b>PETUGAS GIZI</b></h1><br><br>
    <form method="post" action="" role="form">
      <div class="col-lg-4">
        <div align="center">
         <input class="form-control" type="hidden" name="bagian" value="gizi">
         <input class="form-control" type="hidden" name="skor" value="1">
         <button type="submit" name="submitgizi" class="btn">
