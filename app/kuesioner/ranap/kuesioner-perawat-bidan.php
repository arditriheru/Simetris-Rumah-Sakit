...
<?php
if(isset($_POST['submitperawatbidan'])){
  $bagian     = $_POST['bagian'];
  $skor       = $_POST['skor'];
  ...
  if($simpan){
    header("location:kuesioner-dokter-spesialis");
  }
}
?>
<div class="col-lg-12">
  <div align="center" class="row">
    ...
    <h8><b>BIDAN / PERAWAT</b></h8><br><br>
    <form method="post" action="" role="form">
      <div class="col-lg-4">
        <div align="center">
         <input class="form-control" type="hidden" name="bagian" value="perawat_bidan">
         <input class="form-control" type="hidden" name="skor" value="1">
         <button type="submit" name="submitperawatbidan" class="btn">
