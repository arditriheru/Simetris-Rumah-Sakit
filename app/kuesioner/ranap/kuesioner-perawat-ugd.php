...
<?php
if(isset($_POST['submitperawatugd'])){
  $bagian     = $_POST['bagian'];
  $skor       = $_POST['skor'];
  ...
  if($simpan){
    header("location:kuesioner-perawat-bidan");
  }
}
?>
<div class="col-lg-12">
  <div align="center" class="row">
    ...
    <h8><b>PERAWAT UGD</b></h8><br><br>
    <form method="post" action="" role="form">
      <div class="col-lg-4">
        <div align="center">
         <input class="form-control" type="hidden" name="bagian" value="perawat_ugd">
         <input class="form-control" type="hidden" name="skor" value="1">
         <button type="submit" name="submitperawatugd" class="btn">
