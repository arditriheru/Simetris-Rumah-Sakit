...
<?php
if(isset($_POST['submitpoliklinik'])){
  $bagian     = $_POST['bagian'];
  $skor       = $_POST['skor'];
...
<div class="col-lg-12">
  <div align="center" class="row">
    ...
    <h8><b>PETUGAS POLIKLINIK</b></h8><br><br>
    <form method="post" action="" role="form">
      <div class="col-lg-4">
        <div align="center">
         <input class="form-control" type="hidden" name="bagian" value="poliklinik">
         <input class="form-control" type="hidden" name="skor" value="1">
         <button type="submit" name="submitpoliklinik" class="btn">
