...
if(isset($_POST['submitlaborat'])){
  ...
  if($simpan){
    header("location:kuesioner-farmasi");
  }
}
?>
<div class="col-lg-12">
  <div align="center" class="row">
   ...
   <div class="col-lg-8">
    <h7><b>6. PELAYANAN</b></h7><br>
     <h8><b>PETUGAS LABORATORIUM</b></h8><br><br>
   </div>
   <div class="col-lg-2"><br>
    <a href="kuesioner-farmasi">
 ...
 <form method="post" action="" role="form">
  <div class="col-lg-4">
    <div align="center">
     <input class="form-control" type="hidden" name="bagian" value="laboratorium">
     <input class="form-control" type="hidden" name="skor" value="1">
     <button type="submit" name="submitlaborat" class="btn">
