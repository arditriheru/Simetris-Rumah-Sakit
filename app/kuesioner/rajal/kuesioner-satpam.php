...
if(isset($_POST['submitsatpam'])){
  ...
  if($simpan){
    header("location:kuesioner-pendaftaran");
  }
}
?>
<div class="col-lg-12">
 ...
 <div class="col-lg-8">
   <h7><b>2. PELAYANAN</b></h7><br>
   <h8><b>PETUGAS SATPAM</b></h8><br><br>
 </div>
 <div class="col-lg-2"><br>
  <a href="#">
...
<form method="post" action="" role="form">
  <div class="col-lg-4">
    <div align="center">
     <input class="form-control" type="hidden" name="bagian" value="satpam">
     <input class="form-control" type="hidden" name="skor" value="1">
     <button type="submit" name="submitsatpam" class="btn">
