...
mysqli_query($koneksi,"INSERT INTO ant_kandungan(id_ant_kandungan, status, id_sesi, id_dokter)VALUES('$id_ant_kandungan','2','$kandungan_id_sesi','$kandungan_id_dokter')");
mysqli_query($koneksi,"	UPDATE ant_kandungan SET status='2'	WHERE status='1'");
mysqli_query($koneksi,"	UPDATE ant_kandungan SET status='1'	WHERE id_ant_kandungan=$id_ant_kandungan");
