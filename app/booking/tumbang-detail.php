    ...
    <div class="col-lg-6">
      <div class="table-responsive">
       <?php if($status=='Admin'){ ?>
        <div clas="row">
          <div class="col-lg-10">
            <a href="tumbang-datang-proses.php?id_tumbang=<?php echo $id_tumbang; ?>"
              <button onclick="javascript: return confirm('Sudah Datang?')"
              type="button" class="btn btn-success">Datang</button>
            </a>
            <a href="tumbang-belum-datang-proses.php?id_tumbang=<?php echo $id_tumbang; ?>"
              <button onclick="javascript: return confirm('Ubah Belum Datang?')"
              type="button" class="btn btn-warning">Belum Datang</button>
            </a>
            <a href="tumbang-edit.php?id_tumbang=<?php echo $id_tumbang; ?>"
              <button type="button" class="btn btn-primary">Edit</button>
            </a>
          </div>
          <div align="right" class="col-lg-2">
            <a href="tumbang-hapus.php?id_tumbang=<?php echo $id_tumbang; ?>"
