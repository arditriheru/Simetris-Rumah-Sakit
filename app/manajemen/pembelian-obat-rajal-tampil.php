...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      ...
      $akhir = $_POST['akhir'];
      ?>
      <h1>Pembelian Obat <small>Rawat Jalan</small></h1>
      <ol class="breadcrumb">
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="table-responsive">
        <form method="post" action="pembelian-obat-rajal-export.php" role="form">
          <div class="col-lg-6">
