            ...
            <section class="card">
                <a href="registration">
                    <div class="social-box color-1">
                        ...
                        <ul>
                            <h5 class="blacktext">Pendaftaran</h5>
                        </ul>
                    </div>
                </a><!--/social-box-->
            </section>
